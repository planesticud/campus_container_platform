...
until SCHEMASPY_SCHEMA=$SCHEMASPY_SCHEMA DB_BUILD_USER=$DB_BUILD_USER DB_BUILD_NAME=$DB_BUILD_NAME DB_BUILD_PASS=$DB_BUILD_PASS CLIENT_PORT=$CLIENT_PORT PROXY=$http_proxy USER_ID=$UID CLIENT_CLONE_INFO=$CLIENT_CLONE_INFO DOCUMENTOS_CRUD_GET_INFO=$DOCUMENTOS_CRUD_GET_INFO DOCUMENTOS_CRUD_BRANCH_TARGET=$DOCUMENTOS_CRUD_BRANCH_TARGET DOCUMENTOS_CRUD_PORT=$DOCUMENTOS_CRUD_PORT PERSONAS_CRUD_GET_INFO=$PERSONAS_CRUD_GET_INFO PERSONAS_CRUD_BRANCH_TARGET=$PERSONAS_CRUD_BRANCH_TARGET PERSONAS_CRUD_PORT=$PERSONAS_CRUD_PORT UBICACIONES_CRUD_GET_INFO=$UBICACIONES_CRUD_GET_INFO UBICACIONES_CRUD_BRANCH_TARGET=$UBICACIONES_CRUD_BRANCH_TARGET UBICACIONES_CRUD_PORT=$UBICACIONES_CRUD_PORT CAMPUS_MID_GET_INFO=$CAMPUS_MID_GET_INFO CAMPUS_MID_BRANCH_TARGET=$CAMPUS_MID_BRANCH_TARGET CAMPUS_MID_PORT=$CAMPUS_MID_PORT CLIENT_BRANCH_TARGET=$CLIENT_BRANCH_TARGET ENTE_CRUD_GET_INFO=$ENTE_CRUD_GET_INFO ENTE_CRUD_BRANCH_TARGET=$ENTE_CRUD_BRANCH_TARGET ENTE_HTTP_PORT=$ENTE_HTTP_PORT docker-compose exec postgresdb sh -c 'psql -U postgres -c "\c $POSTGRES_DB"' ; do
  >&2 echo "Postgres is unavailable - sleeping"
  sleep 1
done

>&2 echo "Postgres is up - executing command"
    SCHEMASPY_SCHEMA=$SCHEMASPY_SCHEMA DB_BUILD_USER=$DB_BUILD_USER DB_BUILD_NAME=$DB_BUILD_NAME DB_BUILD_PASS=$DB_BUILD_PASS CLIENT_PORT=$CLIENT_PORT PROXY=$http_proxy USER_ID=$UID CLIENT_CLONE_INFO=$CLIENT_CLONE_INFO DOCUMENTOS_CRUD_GET_INFO=$DOCUMENTOS_CRUD_GET_INFO DOCUMENTOS_CRUD_BRANCH_TARGET=$DOCUMENTOS_CRUD_BRANCH_TARGET DOCUMENTOS_CRUD_PORT=$DOCUMENTOS_CRUD_PORT PERSONAS_CRUD_GET_INFO=$PERSONAS_CRUD_GET_INFO PERSONAS_CRUD_BRANCH_TARGET=$PERSONAS_CRUD_BRANCH_TARGET PERSONAS_CRUD_PORT=$PERSONAS_CRUD_PORT UBICACIONES_CRUD_GET_INFO=$UBICACIONES_CRUD_GET_INFO UBICACIONES_CRUD_BRANCH_TARGET=$UBICACIONES_CRUD_BRANCH_TARGET UBICACIONES_CRUD_PORT=$UBICACIONES_CRUD_PORT CAMPUS_MID_GET_INFO=$CAMPUS_MID_GET_INFO CAMPUS_MID_BRANCH_TARGET=$CAMPUS_MID_BRANCH_TARGET CAMPUS_MID_PORT=$CAMPUS_MID_PORT CLIENT_BRANCH_TARGET=$CLIENT_BRANCH_TARGET ENTE_CRUD_GET_INFO=$ENTE_CRUD_GET_INFO ENTE_CRUD_BRANCH_TARGET=$ENTE_CRUD_BRANCH_TARGET ENTE_HTTP_PORT=$ENTE_HTTP_PORT docker-compose exec postgresdb sh -c 'pg_restore -h localhost -p 5432 -U $POSTGRES_USER -d $POSTGRES_DB -v "/bkup/bkup.backup"'
...
#done
SCHEMASPY_SCHEMA=$SCHEMASPY_SCHEMA DB_BUILD_USER=$DB_BUILD_USER DB_BUILD_NAME=$DB_BUILD_NAME DB_BUILD_PASS=$DB_BUILD_PASS CLIENT_PORT=$CLIENT_PORT PROXY=$http_proxy USER_ID=$UID CLIENT_CLONE_INFO=$CLIENT_CLONE_INFO DOCUMENTOS_CRUD_GET_INFO=$DOCUMENTOS_CRUD_GET_INFO DOCUMENTOS_CRUD_BRANCH_TARGET=$DOCUMENTOS_CRUD_BRANCH_TARGET DOCUMENTOS_CRUD_PORT=$DOCUMENTOS_CRUD_PORT PERSONAS_CRUD_GET_INFO=$PERSONAS_CRUD_GET_INFO PERSONAS_CRUD_BRANCH_TARGET=$PERSONAS_CRUD_BRANCH_TARGET PERSONAS_CRUD_PORT=$PERSONAS_CRUD_PORT UBICACIONES_CRUD_GET_INFO=$UBICACIONES_CRUD_GET_INFO UBICACIONES_CRUD_BRANCH_TARGET=$UBICACIONES_CRUD_BRANCH_TARGET UBICACIONES_CRUD_PORT=$UBICACIONES_CRUD_PORT CAMPUS_MID_GET_INFO=$CAMPUS_MID_GET_INFO CAMPUS_MID_BRANCH_TARGET=$CAMPUS_MID_BRANCH_TARGET CAMPUS_MID_PORT=$CAMPUS_MID_PORT CLIENT_BRANCH_TARGET=$CLIENT_BRANCH_TARGET ENTE_CRUD_GET_INFO=$ENTE_CRUD_GET_INFO ENTE_CRUD_BRANCH_TARGET=$ENTE_CRUD_BRANCH_TARGET ENTE_HTTP_PORT=$ENTE_HTTP_PORT docker-compose run schemaspy sh -c 'java -jar schemaSpy.jar -t pgsql -o /output -dp postgresql-jre6.jar -host database -port 5432 -u $POSTGRES_USER -p $POSTGRES_PASSWORD -db $POSTGRES_DB -s $SCHEMASPY_SCHEMA' 
echo "ejecutando contenedor..."
